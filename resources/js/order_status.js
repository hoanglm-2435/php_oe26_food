    ...
    swal({
        ...
        .then((result) => {
            if (result) {
                ...
                $(this).removeClass('btn-success approve-order').addClass('btn-default unapproved-order');
                $(this).attr("title", 'Hủy');
    ...
    swal({
        ...
        .then((result) => {
            if (result) {
                ...
                $(this).removeClass('btn-default unapproved-order').addClass('btn-success approve-order');
