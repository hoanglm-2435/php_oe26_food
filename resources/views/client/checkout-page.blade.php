                                        ...
                                        <div class="panel-body">
                                            <div class="shipping-information-wrapper">
                                                <div class="shipping-info-2">
                                                    <span>
                                                        {{ trans('message.name') }}: {{ auth()->user()->name }}
                                                    </span>
                                                    <span>
                                                        {{ trans('message.address') }}: {{ auth()->user()->address }}
                                                    </span>
                                                    <span>
                                                        {{ trans('message.phone') }}: {{ auth()->user()->phone }}
                                                    </span>
                                                </div>
                                                <div class="edit-address">
                                                    <h5>{{ trans('client.message_to_us') }}</h5>
                                                    <textarea placeholder="{{ trans('client.message') }}"
                                                         name="note" class="form-control note" value=""
                                                         required="">
                                                    </textarea>
                                                </div>
                                                <div class="billing-back-btn">
                                                ...
                                                <div class="ship-wrapper">
                                                    <div class="single-ship">
                                                        <input type="radio" name="payment_type" checked
                                                            value="{{ config('payment_type.cash_payment') }}">
                                                        <label>{{ trans('client.cash_payment') }} </label>
                                                    </div>
                                                    <div class="single-ship">
                                                        <input type="radio" name="payment_type"
                                                            value="{{ config('payment_type.card_payment') }}">
                                                    ...
                                                    <div class="billing-back-btn">
                                                        <span>
                                                            ...
                                                            <a href="{{ route('cart.index') }}">
                                                                {{ trans('client.edit_cart') }}
                                                            </a>
                                                        </span>
                                                        <div class="billing-btn">
                                                            <button type="submit" class="payment">
                                                                {{ trans('client.checkout') }}
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
