                ...
                <div class="col-lg-9">
                    ...
                    <div class="shop-topbar-wrapper">
                        <div class="shop-topbar-left">
                            <ul class="view-mode">
                                <li class="active"><a href="#" data-view="product-grid"><i class="fa fa-th"></i></a></li>
                            </ul>
                        </div>
                        <div class="product-sorting-wrapper">
                            <form id="form-sort" method="get">
                                <div class="product-show shorting-style">
                                    <label><b><i class="fas fa-sort"></i> {{ trans('client.sort_by') }}:</b></label>
                                    <label>
                                        <select class="sort-by" name="sortBy">
                                            ...
                                            <option value="desc" {{ Request::get('sortBy') == 'desc' ? "selected='selected'" : "" }}
                                            >{{ trans('client.lasted') }}</option>
                                            <option value="asc" {{ Request::get('sortBy') == 'asc' ? "selected='selected'" : "" }}
                                            >{{ trans('client.old_products') }}</option>
                                            <option value="price_asc" {{ Request::get('sortBy') == 'price_asc' ? "selected='selected'" : "" }}
                                            >{{ trans('client.price_increase') }}</option>
                                            <option value="price_desc" {{ Request::get('sortBy') == 'price_desc' ? "selected='selected'" : "" }}
                                            >{{ trans('client.price_descending') }}</option>
                                            <option value="rating_desc" {{ Request::get('sortBy') == 'rating_desc' ? "selected='selected'" : "" }}
                    ...
                    <div class="shop-sidebar-wrapper gray-bg-7 shop-sidebar-mrg">
                        <form id="form-filter" method="get">
                            <div class="shop-widget">
                                <h4 class="shop-sidebar-title"><i class="fas fa-sort"></i> {{ trans('client.shop_by_categories') }}</h4>
                            ...
                            <div class="shop-widget mt-40 shop-sidebar-border pt-35">
                                <h4 class="shop-sidebar-title"><i class="fas fa-sort"></i> {{ trans('client.by_size') }}</h4>
